              ...
              @csrf
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input value="{{$data['title']}}" type="text" name="title"  class="form-control" id="exampleInputEmail1" placeholder="Enter title" multiple>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">Price</label>
                    <input value="{{$data['price']}}" type="text" name="price" class="form-control" id="exampleInputPassword1" placeholder="Price" multiple>
                  </div>
                  <!-- <div class="form-group">
